            ...
            <tr className="w-full  ">
              <td className="px-6 py-4 border-r border-white text-white text-right w-1/2">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="text-sm">2022 to Present</div>
                  <div className="text-xs ">
                    Developed a CI/CD pipeline for automatic code deployment on
                    Firebase, enabling continuous updates and reducing
                    deployment time by 30%. Developed dynamic data insertion and
                    PDF file creation features using NodeJS and Google Docs
                    APIs. Created RESTful API endpoints to facilitate frontend
                    data consumption. Established a CI/CD pipeline for automatic
                    backend deployment on EC2 instances using AWS CodeDeploy,
                    reducing deployment time by 80% and ensuring consistent and
                    reliable deployments. Configured auto-scaling and load
                    balancing with EC2 Services, resulting in a 50% increase in
                    concurrent user capacity and improved system performance
                    during peak traffic periods. Developed and implemented
                    server-side automation for AI-driven automatic replies to
                    user reviews on Google and Yelp, enhancing customer
                    engagement and reducing reply time by up to 90%. Developed a
                    cross-platform food ordering application for Android and
                    iOS, providing a seamless user experience and serving over
                    1000+ users. Integrated Google services including Firebase,
                    Maps for location-based services, and Notifications for
                    timely updates. Implemented Redux for efficient state
                    management, ensuring data consistency and improving
                    application performance by 30%. Created beautiful UI
                    components using Material Design principles.
                  </div>
                </div>
              </td>
